class Configurations:
    ...
    _music_fadeout_time=_game_over_screen_time*1000 #Duración del desvanecimiento de la música.

    # Se cargan los sonidos del juego
    _music_path="../media/music.mp3"
    _start_sound = "../media/start_sound.wav"
    _eats_apple_sound = "../media/eats_apple_sound.wav"
    _game_over_sound = "../media/game_over_sound.wav"
    ...
    @classmethod
    def get_eats_apple_sound(cls)->str:
        """
        Getter para background_image_path.
        :return:
        """
        return cls._eats_apple_sound

    @classmethod
    def get_game_over_sound(cls)->str:
        """
        Getter para background_image_path.
        :return:
        """
        return cls._game_over_sound